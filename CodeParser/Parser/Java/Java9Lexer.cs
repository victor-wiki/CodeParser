...
public partial class Java9Lexer : Lexer {
	...
	private bool JavaLetter_sempred(RuleContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0: return Character.isJavaIdentifierStart(InputStream.LA(-1));
		case 1: return Character.isJavaIdentifierStart(Character.toCodePoint((char)InputStream.LA(-2), (char)InputStream.LA(-1)));
		}
		return true;
	}
	private bool JavaLetterOrDigit_sempred(RuleContext _localctx, int predIndex) {
		switch (predIndex) {
		case 2: return Character.isJavaIdentifierPart(InputStream.LA(-1));
		case 3: return Character.isJavaIdentifierPart(Character.toCodePoint((char)InputStream.LA(-2), (char)InputStream.LA(-1)));
		}
		return true;
	}
	...
	private static char[] _serializedATN = {
		...
		'\x3', '\xA1', '\x3', '\xA1', '\x3', '\xA1', '\x5', '\xA1', '\x47F', '\n', 
		'\xA1', '\x3', '\xA2', '\x3', '\xA2', '\x3', '\xA2', '\x3', '\xA2', '\x3', 
		'\xA2', '\x3', '\xA2', '\x5', '\xA2', '\x487', '\n', '\xA2', '\x3', '\xA3', 
		'\x6', '\xA3', '\x48A', '\n', '\xA3', '\r', '\xA3', '\xE', '\xA3', '\x48B', 
		'\x3', '\xA3', '\x3', '\xA3', '\x3', '\xA4', '\x3', '\xA4', '\x3', '\xA4', 
		'\x3', '\xA4', '\a', '\xA4', '\x494', '\n', '\xA4', '\f', '\xA4', '\xE', 
		'\xA4', '\x497', '\v', '\xA4', '\x3', '\xA4', '\x3', '\xA4', '\x3', '\xA4', 
		'\x3', '\xA4', '\x3', '\xA4', '\x3', '\xA5', '\x3', '\xA5', '\x3', '\xA5', 
		'\x3', '\xA5', '\a', '\xA5', '\x4A2', '\n', '\xA5', '\f', '\xA5', '\xE', 
		'\xA5', '\x4A5', '\v', '\xA5', '\x3', '\xA5', '\x3', '\xA5', '\x3', '\x495', 
		'\x2', '\xA6', '\x3', '\x3', '\x5', '\x4', '\a', '\x5', '\t', '\x6', '\v', 
		'\a', '\r', '\b', '\xF', '\t', '\x11', '\n', '\x13', '\v', '\x15', '\f', 
		...
		'\x149', 'x', '\x3', '\x2', '\x18', '\x4', '\x2', 'N', 'N', 'n', 'n', 
		...
		'R', 'r', 'r', '\x6', '\x2', '\f', '\f', '\xF', '\xF', ')', ')', '^', 
		'^', '\x6', '\x2', '\f', '\f', '\xF', '\xF', '$', '$', '^', '^', '\n', 
		'\x2', '$', '$', ')', ')', '^', '^', '\x64', '\x64', 'h', 'h', 'p', 'p', 
		't', 't', 'v', 'v', '\x3', '\x2', '\x32', '\x35', '\x6', '\x2', '&', '&', 
		'\x43', '\\', '\x61', '\x61', '\x63', '|', '\x4', '\x2', '\x2', '\x81', 
		'\xD802', '\xDC01', '\x3', '\x2', '\xD802', '\xDC01', '\x3', '\x2', '\xDC02', 
		'\xE001', '\a', '\x2', '&', '&', '\x32', ';', '\x43', '\\', '\x61', '\x61', 
		'\x63', '|', '\x5', '\x2', '\v', '\f', '\xE', '\xF', '\"', '\"', '\x4', 
		'\x2', '\f', '\f', '\xF', '\xF', '\x2', '\x4B7', '\x2', '\x3', '\x3', 
		...
		'\x3', '\x2', '\x2', '\x2', '\x141', '\x47E', '\x3', '\x2', '\x2', '\x2', 
		'\x143', '\x486', '\x3', '\x2', '\x2', '\x2', '\x145', '\x489', '\x3', 
		'\x2', '\x2', '\x2', '\x147', '\x48F', '\x3', '\x2', '\x2', '\x2', '\x149', 
		'\x49D', '\x3', '\x2', '\x2', '\x2', '\x14B', '\x14C', '\a', 'q', '\x2', 
