...
public partial class Java9ParserBaseListener : IJava9ParserListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterEmptyStatement_([NotNull] Java9Parser.EmptyStatementContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="Java9Parser.emptyStatement_"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitEmptyStatement_([NotNull] Java9Parser.EmptyStatementContext context) { }
	/// <summary>
